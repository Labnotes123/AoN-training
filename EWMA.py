...
if uploaded_file:
    ...
    if values.size > 0: # **KIỂM TRA DỮ LIỆU VALUES CÓ RỖNG HAY KHÔNG**
        ...
        default_lower_value = percentile_values_lookup[default_lower_percentile]
        default_upper_value = percentile_values_lookup[default_upper_percentile]
        ...
        try:
            ...
            if 0 <= lower_percentile_input_val <= 100: # **KIỂM TRA PERCENTILE NHẬP VÀO CÓ HỢP LỆ KHÔNG**
                ...
                lower_limit = default_lower_value # Reset giá trị limit về default
        ...
        try:
            ...
            if 0 <= upper_percentile_input_val <= 100: # **KIỂM TRA PERCENTILE NHẬP VÀO CÓ HỢP LỆ KHÔNG**
                ...
                upper_limit = default_upper_value # Reset giá trị limit về default
        ...
        st.warning("Selected column contains no data after cleaning. Please select another column or upload a different file.")
